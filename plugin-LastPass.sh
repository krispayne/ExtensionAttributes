...
# Name    : plugin-LastPass.sh
# Author  : Nick Smith
# Date    : 20140808
# Purpose : Detects if LastPass extension is installed for Firefox  

# MyVariables
currentUser=$(ls -l /dev/console | cut -d " " -f 4) 

# Begin Script
if [ -e /Users/$currentUser/Library/Application\ Support/Firefox/Profiles/*.default/extensions/support@lastpass.com ] #1
	then
theStatus="True"
	else
theStatus="False"
